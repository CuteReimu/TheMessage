...
import com.fengsheng.handler.skill_jie_dao_sha_ren_a_tos
...
class skill_jie_dao_sha_ren_a_tos : AbstractProtoHandler<Role.skill_jie_dao_sha_ren_a_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_jie_dao_sha_ren_a_tos) {
        val skill = r.findSkill<ActiveSkill>(SkillId.JIE_DAO_SHA_REN)
        if (skill == null) {
            skill_jie_dao_sha_ren_a_tos.Companion.log.error("你没有这个技能")
            return
        }
