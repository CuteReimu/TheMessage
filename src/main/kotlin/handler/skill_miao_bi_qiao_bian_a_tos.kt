...
import com.fengsheng.handler.skill_miao_bi_qiao_bian_a_tos
...
class skill_miao_bi_qiao_bian_a_tos : AbstractProtoHandler<Role.skill_miao_bi_qiao_bian_a_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_miao_bi_qiao_bian_a_tos) {
        val skill = r.findSkill<ActiveSkill>(SkillId.MIAO_BI_QIAO_BIAN)
        if (skill == null) {
            skill_miao_bi_qiao_bian_a_tos.Companion.log.error("你没有这个技能")
            return
        }
