...
import com.fengsheng.handler.skill_jiang_hu_ling_b_tos
...
class skill_jiang_hu_ling_b_tos : AbstractProtoHandler<Role.skill_jiang_hu_ling_b_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_jiang_hu_ling_b_tos?) {
        val skill = r.findSkill<Skill>(SkillId.JIANG_HU_LING2)
        if (skill == null) {
            skill_jiang_hu_ling_b_tos.Companion.log.error("你没有这个技能")
            return
        }
