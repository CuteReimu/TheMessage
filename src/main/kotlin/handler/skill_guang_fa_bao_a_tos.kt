...
import com.fengsheng.handler.skill_guang_fa_bao_a_tos
...
class skill_guang_fa_bao_a_tos : AbstractProtoHandler<Role.skill_guang_fa_bao_a_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_guang_fa_bao_a_tos) {
        val skill = r.findSkill<ActiveSkill>(SkillId.GUANG_FA_BAO)
        if (skill == null) {
            skill_guang_fa_bao_a_tos.Companion.log.error("你没有这个技能")
            return
        }
