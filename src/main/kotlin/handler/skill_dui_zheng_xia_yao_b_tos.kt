...
import com.fengsheng.handler.skill_dui_zheng_xia_yao_b_tos
...
class skill_dui_zheng_xia_yao_b_tos : AbstractProtoHandler<Role.skill_dui_zheng_xia_yao_b_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_dui_zheng_xia_yao_b_tos) {
        ...
        if (skill == null) {
            skill_dui_zheng_xia_yao_b_tos.Companion.log.error("你没有这个技能")
            return
        }
        if (HashSet(pb.cardIdsList).size != pb.cardIdsCount) {
            skill_dui_zheng_xia_yao_b_tos.Companion.log.error("卡牌重复" + Arrays.toString(pb.cardIdsList.toTypedArray()))
            return
        }
