...
import com.fengsheng.handler.skill_jin_kou_yi_kai_a_tos
...
class skill_jin_kou_yi_kai_a_tos : AbstractProtoHandler<Role.skill_jin_kou_yi_kai_a_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_jin_kou_yi_kai_a_tos) {
        val skill = r.findSkill<ActiveSkill>(SkillId.JIN_KOU_YI_KAI)
        if (skill == null) {
            skill_jin_kou_yi_kai_a_tos.Companion.log.error("你没有这个技能")
            return
        }
