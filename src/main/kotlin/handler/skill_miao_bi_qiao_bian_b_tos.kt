...
class skill_miao_bi_qiao_bian_b_tos : AbstractProtoHandler<skill_miao_bi_qiao_bian_b_tos>() {
    override fun handle0(r: HumanPlayer, pb: skill_miao_bi_qiao_bian_b_tos) {
