...
import com.fengsheng.handler.skill_dui_zheng_xia_yao_c_tos
...
class skill_dui_zheng_xia_yao_c_tos : AbstractProtoHandler<Role.skill_dui_zheng_xia_yao_c_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_dui_zheng_xia_yao_c_tos?) {
        val skill = r.findSkill<Skill>(SkillId.DUI_ZHENG_XIA_YAO)
        if (skill == null) {
            skill_dui_zheng_xia_yao_c_tos.Companion.log.error("你没有这个技能")
            return
        }
