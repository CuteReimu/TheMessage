...
import com.fengsheng.handler.skill_yi_ya_huan_ya_tos
...
class skill_yi_ya_huan_ya_tos : AbstractProtoHandler<Role.skill_yi_ya_huan_ya_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_yi_ya_huan_ya_tos?) {
        val skill = r.findSkill<Skill>(SkillId.YI_YA_HUAN_YA)
        if (skill == null) {
            skill_yi_ya_huan_ya_tos.Companion.log.error("你没有这个技能")
            return
        }
