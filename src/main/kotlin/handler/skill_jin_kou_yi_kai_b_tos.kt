...
import com.fengsheng.handler.skill_jin_kou_yi_kai_b_tos
...
class skill_jin_kou_yi_kai_b_tos : AbstractProtoHandler<Role.skill_jin_kou_yi_kai_b_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_jin_kou_yi_kai_b_tos?) {
        val skill = r.findSkill<Skill>(SkillId.JIN_KOU_YI_KAI)
        if (skill == null) {
            skill_jin_kou_yi_kai_b_tos.Companion.log.error("你没有这个技能")
            return
        }
