...
com.fengsheng.Playerimport com.fengsheng.ResolveResultimport com.fengsheng.card.Cardimport com.fengsheng.phase.FightPhaseNext com.fengsheng.protos.Common.card_type
...
class FightPhaseIdle(
     ...
     * 正在询问谁
     */
    var whoseFightTurn: Player,
    /**
     * 情报是否面朝上
     */
    var isMessageCardFaceUp: Boolean
) : Fsm {
    override fun resolve(): ResolveResult? {
        if (!whoseFightTurn.isAlive || whoseFightTurn.game.jinBiPlayer === whoseFightTurn) return ResolveResult(
            FightPhaseNext(this),
            true
        )
    ...
    override fun toString(): String {
        return whoseTurn.toString() + "的回合的争夺阶段，情报在" + inFrontOfWhom + "面前，正在询问" + whoseFightTurn
    }
}