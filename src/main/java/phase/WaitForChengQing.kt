package com.fengsheng.phaseimportimportimport

com.fengsheng.phase.WaitForChengQingimport org.apache.log4j.Loggerimport java.util.* com.fengsheng.*import org.apache.log4j.Logger
import java.util.*
...
class WaitForChengQing(
    ...
    override fun resolve(): ResolveResult? {
        WaitForChengQing.Companion.log.info("正在询问" + askWhom + "是否使用澄清")
    ...
    override fun toString(): String {
        return whoseTurn.toString() + "的回合，" + whoDie + "濒死，向" + askWhom + "求澄清"
    }
