...
com.fengsheng.phase.WaitForChengQingimport com.fengsheng.protos.Commonimport com.fengsheng.protos.Common.card com.fengsheng.protos.Common.card_type
 ...
 * 濒死求澄清时，使用了澄清
 */
class UseChengQingOnDying(waitForChengQing: WaitForChengQing) : Fsm {
    override fun resolve(): ResolveResult? {
        var count = 0
        for (card in waitForChengQing.whoDie.messageCards.values) {
