package com.fengsheng.cardimport

import com.fengsheng.Playerimport

com.fengsheng.card.* com.fengsheng.protos.Common.card_type
...
class PlayerAndCard(player: Player, val card: Card) {
    val player: Player
