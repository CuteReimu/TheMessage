...
import com.fengsheng.handler.skill_mian_li_cang_zhen_tos
...
class skill_mian_li_cang_zhen_tos : AbstractProtoHandler<Role.skill_mian_li_cang_zhen_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_mian_li_cang_zhen_tos?) {
        val skill = r.findSkill<Skill>(SkillId.MIAN_LI_CANG_ZHEN)
        if (skill == null) {
            skill_mian_li_cang_zhen_tos.Companion.log.error("你没有这个技能")
            return
        }
