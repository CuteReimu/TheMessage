...
import com.fengsheng.handler.skill_miao_bi_qiao_bian_b_tos
...
class skill_miao_bi_qiao_bian_b_tos : AbstractProtoHandler<Role.skill_miao_bi_qiao_bian_b_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_miao_bi_qiao_bian_b_tos?) {
        val skill = r.findSkill<Skill>(SkillId.MIAO_BI_QIAO_BIAN)
        if (skill == null) {
            skill_miao_bi_qiao_bian_b_tos.Companion.log.error("你没有这个技能")
            return
        }
