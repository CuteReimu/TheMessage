...
import com.fengsheng.handler.skill_jiang_hu_ling_a_tos
...
class skill_jiang_hu_ling_a_tos : AbstractProtoHandler<Role.skill_jiang_hu_ling_a_tos?>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_jiang_hu_ling_a_tos?) {
        val skill = r.findSkill<Skill>(SkillId.JIANG_HU_LING)
        if (skill == null) {
            skill_jiang_hu_ling_a_tos.Companion.log.error("你没有这个技能")
            return
        }
