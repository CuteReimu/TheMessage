...
import com.fengsheng.handler.skill_xin_si_chao_tos
...
class skill_xin_si_chao_tos : AbstractProtoHandler<Role.skill_xin_si_chao_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_xin_si_chao_tos) {
        val skill = r.findSkill<ActiveSkill>(SkillId.XIN_SI_CHAO)
        if (skill == null) {
            skill_xin_si_chao_tos.Companion.log.error("你没有这个技能")
            return
        }
