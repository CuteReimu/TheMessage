...
import com.fengsheng.handler.skill_yi_hua_jie_mu_tos
...
class skill_yi_hua_jie_mu_tos : AbstractProtoHandler<Role.skill_yi_hua_jie_mu_tos>() {
    override fun handle0(r: HumanPlayer, pb: Role.skill_yi_hua_jie_mu_tos) {
        val skill = r.findSkill<ActiveSkill>(SkillId.YI_HUA_JIE_MU)
        if (skill == null) {
            skill_yi_hua_jie_mu_tos.Companion.log.error("你没有这个技能")
            return
        }
