...
public class use_ping_heng_tos extends AbstractProtoHandler<Fengsheng.use_ping_heng_tos> {
    private static final Logger log = Logger.getLogger(use_ping_heng_tos.class);

    @Override
    protected void handle0(HumanPlayer r, Fengsheng.use_ping_heng_tos pb) {
        ...
        if (card.getType() != Common.card_type.Ping_Heng) {
