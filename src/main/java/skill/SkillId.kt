package com.fengsheng.skillimportimport

com.fengsheng.skill.SkillId com.fengsheng.protos.Common.card_type
...
enum class SkillId(private override val name: String) {
