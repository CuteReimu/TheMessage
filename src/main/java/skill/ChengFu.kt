...
com.fengsheng.skill.AbstractSkillimport com.fengsheng.skill.SkillId com.fengsheng.protos.Common.card_type
 ...
 */
class ChengFu : AbstractSkill() {
    override fun getSkillId(): SkillId? {
        return SkillId.CHENG_FU
    }
}